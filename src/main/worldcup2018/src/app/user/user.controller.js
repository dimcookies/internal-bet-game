    ...
    fetchBets() {
        ...
        this.$http.get("/bets/list?userName=" + self.userName).then(function(response) {
            ...
            if (_.last(self.allowedMatchDays) >= '3') {
                ...
                if (groupedByMatchDay["1"] && groupedByMatchDay["2"] && groupedByMatchDay["3"] && p123.length > 0) {
            ...
            if (_.last(self.allowedMatchDays) >= '4' && groupedByMatchDay["4"] && groupedByMatchDay["4"].length > 0) {
            ...
            if (_.last(self.allowedMatchDays) >= '5' && groupedByMatchDay["5"] && groupedByMatchDay["5"].length > 0) {
            ...
            if (_.last(self.allowedMatchDays) >= '6' && groupedByMatchDay["6"] && groupedByMatchDay["6"].length > 0) {
            ...
            if (_.last(self.allowedMatchDays) >= '8' && groupedByMatchDay["8"] && groupedByMatchDay["8"].length > 0) {
